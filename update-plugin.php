...
function install_kissai_updater() {
    ...
    $updater_dir = dirname( KISSAI_PLUGIN_DIR ) . '/kissai-updater';
...
add_action('admin_post_kissai_update_plugin', 'kissai_update_plugin');
...
function kissai_display_update_plugin() {
    if (!current_user_can('manage_options')) {
        return;
    }
    ...
    $current_version = kissai_get_plugin_version();
    global $kissai_api;
    $user = $kissai_api->get_current_kissai_user();
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        <input type="hidden" name="action" value="kissai_update_plugin" />
    ...
    <?php
// DevCode Begins
    //echo kissai_render_rollback_form_from_backup();
// DevCode Ends
}

// DevCode Begins
function kissai_render_rollback_form_from_backup() {
    $upload_dir  = wp_upload_dir();
    $backup_dir = $upload_dir['basedir'] . '/kissai_backups';
